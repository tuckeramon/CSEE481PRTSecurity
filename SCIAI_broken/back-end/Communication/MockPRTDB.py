...
from Communication.MockDatabase import MockDatabase


class MockPRTDB(MockDatabase):
    """Mock PRTDB that uses in-memory storage instead of MySQL."""

    def store_sorter_request(self, sorter: int, barcode: str, transaction_id: int):
        """
        Insert a sorter request record into the mock database.
        """
        query = """
    ...
    def store_sorter_response(self, sorter: int, transaction_id: int, barcode: str, destination: int):
        """
        Insert a sorter response record into the mock database.
        """
        query = """
    ...
    def store_sorter_report(self, sorter: int, barcode: str, active: bool, lost: bool, good: bool, diverted: bool):
        """
        Insert a sorter report record into the mock database.
        """
        query = """
    ...
    def store_destination_info(self, barcode: str, destination: int):
        """
        Insert a record containing the destination for a barcode into the mock database.
        """
        query = """
    ...
    def update_destination_info(self, barcode: str, destination: int):
        """
        Update the destination for a specific barcode in the mock database.
        """
        query = """
        UPDATE PRTCarts
        SET destination = %s
    ...
    def get_destination_info(self, barcode: str):
        """
        Get a destination associated with a specific barcode from the mock database.
        """
        query = """
    ...
    def get_destinations_info(self):
        """
        Get all destination records for valid barcodes from the mock database.
        """
        query = """
        SELECT * FROM PRTCarts
        """
    ...
    def store_remove_cart(self, barcode: str, area: int):
        """
        Insert a record containing the removal request of a cart into the mock database.
        """
        query = """
